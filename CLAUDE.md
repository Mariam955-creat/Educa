...
- migrations Flyway `V1`+`V2`+`V3` (`V3__languages.sql`, table `languages`, 2026-09-15) ; `DevDataInitializer` : 4 comptes (admin, formateur, apprenant, `diplome@educa.dev`) + 2 cours de démo publiés (contrôle + examen final chacun) + parcours du compte diplômé rejoué → certificat pré-émis.
