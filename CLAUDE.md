...
Backend **opérationnel et testé** (`./mvnw test` → **46 tests verts** : auth 8, course 5, quiz 4, ai 9, upload-security 3, contexte 1, admin-user 7, admin-certificate 2, admin-language 7), API sur **:8081** :
