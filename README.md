...
Résiduel connu (hors périmètre MVP) : clé Anthropic réelle pour le chatbot live, traductions du contenu des cours (`course_translations`/`chapter_translations`, pas de table).
