...
| 6 — Rédaction finale & soutenance | en cours — `README.md` réécrit, scénario de soutenance (`docs/05`), jeu de démo enrichi (4 comptes, 2 cours, 1 certificat pré-émis), diagrammes archi + MCD exportés (`docs/assets/`). Reste : vérif bout-en-bout (6.5), déploiement Docker (6.6), passe finale `docs/01`+`02` (6.1) | 2026-09-10 | — |
